...
const appointmentsData = [
  ...
  { id: "00002", nom: "MARCHESSE", animal: "Morsay", espece: "Chat", type: "Consultation", date: "2024-01-27T17:00", veterinaire: "Dr. Durand" },
  { id: "00003", nom: "RAMA", animal: "Clément", espece: "Chat", type: "Consultation", date: "2024-01-27T08:00", veterinaire: "Dr. Dupont" },
  { id: "00004", nom: "HETZEL", animal: "Tounsy", espece: "Chien", type: "Opération", date: "2024-01-28T12:00", veterinaire: "Dr. Lefevre" },
  { id: "00005", nom: "FERNANDES", animal: "Richard", espece: "Chat", type: "Soin", date: "2024-01-28T15:00", veterinaire: "Dr. Dupont" },
  { id: "00006", nom: "FERNANDES", animal: "Paulo", espece: "Chat", type: "Opération", date: "2024-01-29T14:00", veterinaire: "Dr. Lefevre" },
  { id: "00007", nom: "BARAGOUTOU", animal: "Caramel", espece: "Chien", type: "Consultation", date: "2024-01-29T17:00", veterinaire: "Dr. Durand" },
  { id: "00008", nom: "MAURICE", animal: "Claudio", espece: "Chien", type: "Soin", date: "2024-01-30T08:00", veterinaire: "Dr. Dupont" },
  { id: "00009", nom: "BELMADI", animal: "Ryad", espece: "Chien", type: "Opération", date: "2024-01-30T10:00", veterinaire: "Dr. Lefevre" }
];
...
export default function RendezVous() {
  ...
  const filteredNomOptions = uniqueNoms.filter(nom =>
    nom.toLowerCase().includes(searchNom.toLowerCase())
  );
      ...
      <table className="w-full text-sm text-left bg-white rounded shadow">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="p-2">Vétérinaire</th>
        ...
        <tbody>
          {filteredAppointments.map((app) => (
            <tr key={app.id} className="border-t">
              ...
              <td className="p-2">
                {new Date(app.date).toLocaleDateString()} - {new Date(app.date).getHours()}h
              </td>
